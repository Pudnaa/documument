...
export default function NewsletterIII() {
    const {
        config,
        datasrc,
        otherattr,
      ...
      // console.log("NewsletterIII config", config);
      // console.log("NewsletterIII datasrc", datasrc);
      // console.log("NewsletterIII otherattr", otherattr);
      // console.log("NewsletterIII positionConfig", positionConfig);
    return (
