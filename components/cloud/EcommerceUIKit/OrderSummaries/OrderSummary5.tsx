...
const OrderSummary5 = () => {
    const {
      ...
      // console.log("OrderSummary5 config", config);
      // console.log("OrderSummary5 datasrc", datasrc);
      // console.log("OrderSummary5 otherattr", otherattr);
      // console.log("OrderSummary5 positionConfig", positionConfig);
    return (
