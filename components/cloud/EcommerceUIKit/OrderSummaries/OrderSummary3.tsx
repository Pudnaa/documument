...
const OrderSummary3 = () => {
    const {
      ...
      // console.log("OrderSummary3 config", config);
      // console.log("OrderSummary3 datasrc", datasrc);
      // console.log("OrderSummary3 otherattr", otherattr);
      // console.log("OrderSummary3 positionConfig", positionConfig);
    return (
