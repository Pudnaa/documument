...
export default function ProductGrid2() {
  ...
  // console.log("ProductGrid2 config", config);
  // console.log("ProductGrid2 datasrc", datasrc);
  // console.log("ProductGrid2 otherattr", otherattr);
  // console.log("ProductGrid2 positionConfig", positionConfig);
          ...
          <div className="relative">
            ...
            <div className="absolute sm:bottom-8 bottom-4 pr-10 sm:pr-0 left-4 sm:left-8 flex justify-start items-start">
              <AtomTitle
                ...
                customClassName="text-3xl sm:text-4xl font-semibold leading-9 text-white"
              />
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  <AtomImage
                    ...
                    customClassName="group-hover:opacity-60 transition duration-500"
                  ...
                  <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                    <div>
                      <AtomTitle
                        ...
                        customClassName="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600"
                      />
                    </div>
                    <div>
                      <AtomCurrency
                        ...
                        customClassName="group-hover:opacity-60 transition duration-500 text-xl font-semibold leading-5 text-gray-800"
                      />
                    </div>
                  </div>
