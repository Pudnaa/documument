...
export default function ProductGridOrgil1() {
  const {
    config,
    datasrc,
    widgetnemgoo,
  ...
  return (
    <>
      <div className="flex justify-center items-center w-full mt-5 p-10">
        <button className="bg-red-500 text-white uppercase font-normal py-2 px-4 border border-red-500 rounded-full center">
          Шинээр нэмэгдсэн
        </button>
