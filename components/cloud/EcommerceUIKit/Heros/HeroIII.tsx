...
const HeroIII = () => {
    const {
      ...
      // console.log("HeroIII config", config);
      // console.log("HeroIII datasrc", datasrc);
      // console.log("HeroIII otherattr", otherattr);
      // console.log("HeroIII positionConfig", positionConfig);
    return (
