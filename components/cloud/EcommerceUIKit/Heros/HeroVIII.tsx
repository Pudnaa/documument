...
const HeroVIII = () => {
    const {
      ...
      // console.log("HeroVIII config", config);
      // console.log("HeroVIII datasrc", datasrc);
      // console.log("HeroVIII otherattr", otherattr);
      // console.log("HeroVIII positionConfig", positionConfig);
    return (
