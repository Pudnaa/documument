          ...
          <RenderAtom
                 item={item?.position4}
                  ...
                  customClassName="text-lg font-semibold text-gray-900"
                   />
                   <p className="mt-5 text-sm font-medium text-gray-900"> KABEER CHOPRACO-FOUNDER AND CPO, BURROW</p>
          </div>
...
export default WeeklyLanding2CtaIII;