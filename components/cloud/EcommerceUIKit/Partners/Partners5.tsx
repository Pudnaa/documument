...
const Partners5 = () => {
  ...
  // console.log("Partners5 config", config);
  // console.log("Partners5 datasrc", datasrc);
  // console.log("Partners5 otherattr", otherattr);
  // console.log("Partners5 positionConfig", positionConfig);
  return (
    <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9 ">
      <h1 className=" text-center lg:mb-20 mb-10 text-gray-800 font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 w-9/12 md:w-full mx-auto">
      ...
      <div className=" relative md:flex justify-center items-center ">
        <div className="md:w-4/12 w-full">
          ...
          <h3 className="text-gray-800 my-4 font-semibold lg:text-2xl text-xl lg:leading-6 leading-5">
            Based On 170 reviews
          </h3>
          <a
            href="/"
            className="hover:text-gray-800 focus:outline-none focus:text-black hover:underline text-sm leading-3 text-gray-600 cursor-pointer "
          >
            See all reviews
          </a>
        </div>
                  ...
                  <div className=" w-full">
                    ...
                    <div className="md:w-full h-full relative">
                      <p className=" text-gray-600 font-normal text-base leading-7">
                        ...
                        fear. I am fully satisfied and would recommend buying
                        from them as they have made my life so much easier :)”
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full sm:w-6/12 flex-none ">
                  <div className=" w-full">
                    ...
                    <p className=" text-gray-600 font-normal text-base leading-7">
                      ...
                      satisfied and would recommend buying from them as they
