...
export default function Social1() {
  ...
  // console.log("Social1 config", config);
  // console.log("Social1 datasrc", datasrc);
  // console.log("Social1 otherattr", otherattr);
  // console.log("Social1 positionConfig", positionConfig);
