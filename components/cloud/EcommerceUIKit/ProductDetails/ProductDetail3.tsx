...
const ProductDetail3 = () => {
  ...
  // console.log("ProductDetail3 config", config);
  // console.log("ProductDetail3 datasrc", datasrc);
  // console.log("ProductDetail3 otherattr", otherattr);
  // console.log("ProductDetail3 positionConfig", positionConfig);
  const item = datasrc[0];
  const images = renderPositionType(item, "position31", positionConfig);
  const columnNames = renderPositionType(item, "position33", positionConfig);
...
mt-2"
        ...
        <div className="py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center justify-center">
            <AtomText
              ...
              customClassName="text-sm leading-none text-gray-600 mr-3"
            />
            <svg
              className="cursor-pointer"
              width="6"
        ...
        <div>
          <AtomText
            ...
            customClassName="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7"
          />
          {columnNames.map((item1: any, index1: number) => {
            return (
              <>
                <p
                  key={index1}
                  className={
                    index1 === 0
                      ? "text-base leading-4 mt-7 text-gray-600"
                      : "text-base leading-4 mt-4 text-gray-600"
                  }
                >
                  <AtomText
                    key={index1}
