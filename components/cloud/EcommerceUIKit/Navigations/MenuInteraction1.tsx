...
export default function MenuInteraction1() {
  const {
    config,
    datasrc,
    otherattr,
  ...
  // console.log("MenuInteraction1 config", config);
  // console.log("MenuInteraction1 datasrc", datasrc);
  // console.log("MenuInteraction1 otherattr", otherattr);
  // console.log("MenuInteraction1 positionConfig", positionConfig);
  ...
  return (
    <div className="dark:bg-gray-900 pb-12">
      <div>
        <div className="2xl:container 2xl:mx-auto relative">
          <div className="pt-4 mx-4 md:mx-6 ">
                ...
                <ul className="flex items-center space-x-6">
                  <li>
                    <a
                      ...
                      className="text-gray-800 dark:text-white flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                    >
                      <div>
                        <svg
            ...
            <div className="lg:border-b border-gray-200  pt-4 md:pb-4 flex items-center justify-between">
              <div className="hidden md:block">
                <ul className="flex items-center space-x-6">
                  <li className="h-full">
                    <a
                      href="javascript:void(0)"
                      className="pt-2 md:pb-6 border-transparent border-b-4 h-full focus:border-gray-800  focus:outline-none dark:text-white text-base text-right text-gray-800  "
                    >
                      New
                    </a>
                  </li>
              ...
              <div className="   bg-gray-50 flex items-center dark:bg-gray-800 space-x-3 p-3 w-full md:w-72">
                ...
                <input
                  type="text"
                  className="text-sm text-gray-600 dark:text-white placeholder-gray-600 dark:placeholder-gray-300 bg-transparent focus:outline-none"
          ...
          <div
            id="mobile-menu"
            className={`ease-in-out transition duration-200 dark:bg-gray-900 md:hidden absolute inset-0 z-10 flex flex-col w-full h-screen bg-white py-4 ${
              show ? "" : "hidden"
            } `}
          >
            ...
            <div
              ...
              className={` ${
                slider
                  ? " hidden"
                  : " ease-in-out transition absolute w-full z-20 top-10 bg-white mt-4"
              }`}
            >
              <ul className="flex flex-col space-y-4">
                <li className="border-b border-t border-gray-200 dark:border-gray-700  px-1 flex flex-row items-center justify-start ">
                  <button
                    onClick={() => showSlider(false)}
                    className="border-r px-4 py-6 border-gray-200"
                  >
                    <svg
                      className=" "
                      width={16}
                  ...
                  <div className="w-full text-center">
                    <p
                      id="text"
                      className="  focus:outline-none  py-4  dark:text-white focus:ring-2 font-semibold focus:ring-gray-800 text-xl text-gray-800 hover:underline"
                    >
                      Bags
                    </p>
                  </div>
                </li>
                <li className="border-b border-gray-200 dark:border-gray-700 pb-4 px-1 flex items-center justify-between mx-4">
                  <a
                    href="javascript:void(0)"
                    className="focus:outline-none   dark:text-white focus:ring-2 focus:ring-gray-800 text-base text-gray-800 hover:underline"
                  >
      ...
      <div className="px-4 md:px-6  2xl:mx-auto 2xl:container hidden md:block">
        <div className="flex flex-row">
          <div className="flex flex-col justify-start items-start  pt-12 space-y-6 w-3/12">
            <button className="text-base focus:outline-none font-semibold leading-4 focus:underline text-gray-800">
              For Men
            </button>
            <button className="text-base focus:outline-none  focus:font-semibold  leading-4 focus:underline text-gray-800">
              For Women
            </button>
            <button className="text-base focus:outline-none  focus:font-semibold  leading-4 focus:underline text-gray-800">
              For Kids
          ...
          <div className="relative bg-gray-50 p-12 w-full grid grid-cols-1 xl:grid-cols-3 gap-x-24 gap-y-12  justify-between">
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/dJBVvZd/Rectangle-22.png"
                alt="bag"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/GkgFNSq/Rectangle-22-1.png"
                alt="bag"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Bags
              </p>
              <p className="text-sm leading-3 mt-2 w-full text-left text-gray-800">
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/mXY6T7q/Rectangle-18.png"
                alt="shoes"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/RTxysWR/Rectangle-18-1.png"
                alt="shoes"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Shoes
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/XbPY0vQ/Rectangle-17.png"
                alt="watch"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/TBnMsCP/Rectangle-17-1.png"
                alt="watch"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Watches
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/pZ9VLYY/Rectangle-19.png"
                alt="man"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/WsHP5sH/Rectangle-19-1.png"
                alt="man"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Luxe Signature
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/wsFqcQq/Rectangle-21.png"
                alt="shoe-books"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/dQHhZGh/Rectangle-21-1.png"
                alt="shoe-books"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Luxe X London
            ...
            <div className="flex flex-col justify-center items-center">
              <img
                className="w-full hidden xl:block"
                src="https://i.ibb.co/syNpp4n/Rectangle-20.png"
                alt="wallet"
              />
              <img
                className="w-full xl:hidden"
                src="https://i.ibb.co/8zRMG9w/mason-supply-l-N0-Hny-Sy7w-unsplash-1.png"
                alt="wallet"
              />
              <p className="mt-4 w-full text-left text-xl font-semibold leading-5 text-gray-800">
                Wallets
            ...
            <button
              aria-label="icon"
              className="absolute right-4 top-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
            >
              <svg
                width={18}
                height={18}
