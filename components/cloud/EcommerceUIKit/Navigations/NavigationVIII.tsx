...
export default function NavigationVIII() {
    const {
        config,
        datasrc,
        otherattr,
    ...
    // console.log("NavigationVIII config", config);
    // console.log("NavigationVIII datasrc", datasrc);
    // console.log("NavigationVIII otherattr", otherattr);
    // console.log("NavigationVIII positionConfig", positionConfig);

    return (
        <div>
            <div className="relative">
                {/* For md screen size */}
                <div id="md-searchbar" className={`${mdOptionsToggle ? "flex" : "hidden"} bg-white dark:bg-gray-900 lg:hidden py-5 px-6 items-center justify-between`}>
                ...
                <div className="dark:bg-gray-900 bg-gray-50 px-6 py-9">
                    <div className="container mx-auto flex items-center justify-between">
                        ...
                        <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                            <li>
                                <button onClick={() => setShowMenu(!showMenu)} className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Home
                                </button>
                            </li>
                            <li>
                        ...
                        <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                            <div className="hidden lg:flex items-center">
                                <button onClick={() => setSearch(!search)} aria-label="search items" className="text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                                ...
                                <input id="searchInput" type="text" placeholder="search" className={`${search ? "" : "hidden"} text-sm dark:bg-gray-900 dark:placeholder-gray-300 text-gray-600 rounded ml-1 border border-transparent focus:outline-none focus:border-gray-400 px-1`} />
                            </div>
                            ...
                            <div className="flex lg:hidden">
                                ...
                                <button aria-label="open menu" onClick={() => setMobileMenu(true)} className="text-black dark:text-white dark:hover:text-gray-300 md:hidden focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
                                    <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M10 12H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M6 18H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                {/* For small screen */}
                <div id="mobile-menu" className={`${mobileMenu ? "flex" : "hidden"} absolute dark:bg-gray-900 z-10 inset-0 md:hidden bg-white flex-col h-screen w-full`}>
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
                        ...
                        <button onClick={() => setMobileMenu(false)} aria-label="close menu" className="focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
                    ...
                    <div className="mt-6 p-4">
                        <ul className="flex flex-col space-y-6">
                            <li>
                                <button onClick={() => setShowMenu(!showMenu)} className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800">
                                    Home
                                    <div>
            ...
            <div className="flex flex-col justify-center items-center">
                <div id="menu" className={`${showMenu ? "grid" : "hidden"} bg-white shadow py-6 md:pt-10 md:pb-12 px-10 md:px-12 lg:pl-12 lg:pr-24 gap-y-8 sm:gap-y-0 gap-x-16  grid-cols-2 sm:grid-cols-3`}>
                    <div className="flex flex-col space-y-6">
                        <div>
                            <p className="text-sm font-semibold leading-none text-gray-800 uppercase">New Arrival</p>
                        </div>
                        <div className="flex flex-col space-y-4">
                            <a href="javascript:void(0)" className="cursor-pointer hover:text-gray-600 text-sm leading-none text-gray-800 capitalize list-none">
                                Sofas
                            </a>
                            <a href="javascript:void(0)" className="cursor-pointer hover:text-gray-600 text-sm leading-none text-gray-800 capitalize list-none">
                                Sectionals
                    ...
                    <div className="flex flex-col space-y-6">
                        <div>
                            <p className="text-sm font-semibold leading-none text-gray-800 uppercase">Categories</p>
                        </div>
                        <div className="flex flex-col space-y-4">
                            <a href="javascript:void(0)" className="cursor-pointer hover:text-gray-600 text-sm leading-none text-gray-800 capitalize list-none">
                                chairs
                    ...
                    <div className="flex flex-col space-y-6">
                        <div>
                            <p className="text-sm font-semibold leading-none text-gray-800 uppercase">BRANDS</p>
                        </div>
                        <div className="flex flex-col space-y-4">
                            <a href="javascript:void(0)" className="cursor-pointer hover:text-gray-600 text-sm leading-none text-gray-800 capitalize list-none">
                                Eco.birdy
