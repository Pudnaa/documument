...
export default function NavigationVI() {
    const {
        config,
        datasrc,
        otherattr,
    ...
    // console.log("NavigationVI config", config);
    // console.log("NavigationVI datasrc", datasrc);
    // console.log("NavigationVI otherattr", otherattr);
    // console.log("NavigationVI positionConfig", positionConfig);
