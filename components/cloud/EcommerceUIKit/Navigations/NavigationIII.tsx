...
export default function NavigationIII() {
    const {
        config,
        datasrc,
        otherattr,
    ...
    // console.log("NavigationIII config", config);
    // console.log("NavigationIII datasrc", datasrc);
    // console.log("NavigationIII otherattr", otherattr);
    // console.log("NavigationIII positionConfig", positionConfig);
