...
export default function MenuInteraction2() {
  const {
    config,
    datasrc,
    otherattr,
  ...
  // console.log("MenuInteraction2 config", config);
  // console.log("MenuInteraction2 datasrc", datasrc);
  // console.log("MenuInteraction2 otherattr", otherattr);
  // console.log("MenuInteraction2 positionConfig", positionConfig);
      ...
      <div className="dark:bg-gray-900 pb-12">
        ...
        <div className="px-4 md:px-6  2xl:mx-auto 2xl:container hidden md:block">
          <div className="flex flex-row">
            <div className="flex flex-col justify-start items-start  pt-12 space-y-6 md:w-6/12 lg:w-3/12">
              <button className="text-base focus:outline-none  leading-4 focus:underline text-gray-800">
                For Men
              </button>
              <button className="text-base focus:outline-none  font-semibold focus:font-semibold  leading-4 focus:underline text-gray-800">
                For Women
              </button>
            ...
            <div className="relative bg-gray-50  w-full flex-row ">
              <div className="p-12 flex flex-col justify-start items-start space-y-8 lg:space-y-6">
                <button className="focus:outline-none focus:underline text-base leading-4 font-semibold text-gray-800">
                  Bags
                </button>
                <button className="focus:outline-none focus:underline text-base leading-4 text-gray-800">
                  Shoes
                </button>
                <button className="focus:outline-none focus:underline text-base leading-4 text-gray-800">
                  Watches
            ...
            <div className="w-full relative">
              <img
                ...
                src="https://i.ibb.co/MkR9tYG/Rectangle-24.png"
                alt="shoes"
              />
              <button
                aria-label="icon"
                className="bg-white p-2 absolute right-4 top-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
              >
                <svg
                  width={18}
                  height={18}
