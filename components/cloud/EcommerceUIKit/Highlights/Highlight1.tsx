...
const Highlight1 = () => {
    const {
      ...
      // console.log("Highlight1 config", config);
      // console.log("Highlight1 datasrc", datasrc);
      // console.log("Highlight1 otherattr", otherattr);
      // console.log("Highlight1 positionConfig", positionConfig);
    return (
