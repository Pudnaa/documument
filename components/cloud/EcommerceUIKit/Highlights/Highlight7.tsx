...
const Highlight7 = () => {
    const {
      ...
      // console.log("Highlight7 config", config);
      // console.log("Highlight7 datasrc", datasrc);
      // console.log("Highlight7 otherattr", otherattr);
      // console.log("Highlight7 positionConfig", positionConfig);
    return (
