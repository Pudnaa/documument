...
const Highlight4 = () => {
    const {
      ...
      // console.log("Highlight4 config", config);
      // console.log("Highlight4 datasrc", datasrc);
      // console.log("Highlight4 otherattr", otherattr);
      // console.log("Highlight4 positionConfig", positionConfig);
    return (
        <div className="2xl:container 2xl:mx-auto">
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-24 md:gap-10 gap-12 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                ...
                <div className="flex space-x-4">
                    ...
                    <div>
                        <p className=" text-xl leading-5 font-semibold text-gray-800 ">Free Shipping</p>
                        <p className=" text-base leading-6 font-normal text-gray-600 mt-3">Free shipping on orders above $100</p>
                    </div>
                </div>
                ...
                <div className="flex space-x-4">
                    ...
                    <div>
                        <p className=" text-xl leading-5 font-semibold text-gray-800 ">Support 24/7</p>
                        <p className=" text-base leading-6 font-normal text-gray-600 mt-3">Contact us 24 hours a day at care@supprt.com</p>
                    </div>
                </div>
                ...
                <div className="flex space-x-4">
                    ...
                    <div>
                        <p className=" text-xl leading-5 font-semibold text-gray-800 ">Money Back Guarantee</p>
                        <p className=" text-base leading-6 font-normal text-gray-600 mt-3">You can return the product within 30 days.</p>
                    </div>
                </div>
            </div>
        </div>
