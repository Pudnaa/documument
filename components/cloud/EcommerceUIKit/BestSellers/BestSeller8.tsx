...
const BestSeller8 = () => {
  ...
  // console.log("BestSeller8 config", config);
  // console.log("BestSeller8 datasrc", datasrc);
  // console.log("BestSeller8 otherattr", otherattr);
  // console.log("BestSeller8 positionConfig", positionConfig);
  return (
    <div className="pb-16">
                    ...
                    <div className="flex justify-between mt-4">
                      <div>
                        <AtomText
                          ...
                          customClassName="text-lg font-medium leading-none text-gray-800"
                        />
                      </div>
                      <div>
                        <AtomText
                          ...
                          customClassName="text-lg leading-none text-right text-gray-600"
                        />
                      </div>
                    </div>
                  </div>
