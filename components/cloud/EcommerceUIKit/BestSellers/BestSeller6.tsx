...
const BestSeller6 = () => {
  ...
  // console.log("BestSeller6 config", config);
  // console.log("BestSeller6 datasrc", datasrc);
  // console.log("BestSeller6 otherattr", otherattr);
  // console.log("BestSeller6 positionConfig", positionConfig);
  return (
            ...
            <div className="fle flex-col justify-center items-center">
              <div className="flex justify-start items-start">
                <AtomTitle
                  ...
                  customClassName="text-3xl lg:text-4xl font-semibold leading-9 text-gray-800"
                />
              </div>
                      ...
                      <div className="flex flex-col items-start jusitfy-start mt-3 space-y-3">
                        <div>
                          <AtomText
                            ...
                            customClassName="text-lg font-medium leading-4 text-gray-800"
                          />
                        </div>
                        <div>
                          <AtomText
                            ...
                            customClassName="text-lg leading-4 text-gray-600"
                          />
                        </div>
                      </div>
                    </div>
