...
export default function ModalVI() {
    const {
        config,
        datasrc,
        otherattr,
    ...
    // console.log("ModalVI config", config);
    // console.log("ModalVI datasrc", datasrc);
    // console.log("ModalVI otherattr", otherattr);
    // console.log("ModalVI positionConfig", positionConfig);
        ...
        <div className="bg-gray-800">
            ...
            <div id="modal" className={`${show ? "flex" : "hidden"} container mx-auto justify-center items-center px-4 md:px-10 py-20`}>
                <div className="bg-white px-3 md:px-4 py-12 flex flex-col justify-center items-center">
                    ...
                    <h1 className="mt-8 md:mt-12 text-3xl lg:text-4xl font-semibold leading-10 text-center text-gray-800  md:w-9/12 lg:w-7/12">Welcome to the coveted family of luxe!</h1>
